...
<% if (!edit) { %>
	...
	<tr>
		<td>Nombre</td>
		<td><h:outputText value="#{rfpViewMB.rfp.name}"></h:outputText></td>
	</tr>
	<tr>
		<td>Fecha de Inicio</td>
		<td><h:outputText value="#{rfpViewMB.rfp.startDate}" converter="dateConverter"></h:outputText></td>
	</tr>
	<tr>
		<td>Fecha de Decisi&oacute;n</td>
		<td><h:outputText value="#{rfpViewMB.rfp.decitionDate}" converter="dateConverter"></h:outputText></td>
	</tr>
	<tr>
		<td>Compa&ntilde;&iacute;a</td>
		<td><h:outputText value="#{rfpViewMB.rfp.company}"></h:outputText></td>
	</tr>
	<tr>
		<td>Estado</td>
		<td><h:outputText value="#{rfpViewMB.rfp.status.name}"></h:outputText></td>
	</tr>
	<tr>
		<td>Comentario</td>
		<td><h:outputText value="#{rfpViewMB.rfp.comment}"></h:outputText></td>
	</tr>
	<tr>
		<td>Puntuación</td>
		<td><h:outputText value="#{rfpViewMB.rfp.average}"></h:outputText></td>
	</tr>
	<tr>
		<td>Archivo</td>
